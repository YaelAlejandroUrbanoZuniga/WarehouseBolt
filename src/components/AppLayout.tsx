...
import { faHouse, faCalendarDays, faDoorOpen, faBoxesPacking, faBuilding } from '@fortawesome/free-solid-svg-icons';
...
const NAV_ITEMS: NavItemConRoles[] = [
  ...
  { path: '/proveedores', icon: faBuilding, label: 'Proveedores', roles: ['coordinador'] },
...
export function AppLayout() {
  ...
  return (
    <>
      <GlobalHeader titulo="DOCKFLOW" centro={<RelojActual variante="oscuro" />} derecha={<SelectorRol />} />
      <Sidebar
        collapsed={collapsed}
