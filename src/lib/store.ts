...
import type { Cita, TransicionEstado, Dock, Transportista, Usuario, Rol, Proveedor } from './types';
...
export const proveedoresAtom = makeAtom<Proveedor[]>(`df-proveedores${SUFFIX}`, []);
